// Arrays for transliteration mappings
var text;
var nVowels;
...
var specialChar = new Array()
 ...
 // Define vowels and their Unicode and modifiers
...
// Define special consonants and their Unicode
...
specialConsonantsUni[5] = 'ර්' + '\u200D'; specialConsonants[5] = /\\r/g;
 ...
 // Define consonants and their Unicode
...
function startText() {
    var s, r, v;
    document.getElementById("output-container").classList.add("glow");
...
function copyText() {
    ...
    //Modify the button
    document.getElementById("copy-button").classList.add("coppied");
